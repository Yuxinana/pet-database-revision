...
See [docs/diagrams/er_diagram.png](docs\diagrams\docs/diagrams/er_diagram.png)
...
SQLite is the official execution target for this repository version. The SQL deliverables in `backend/app/db/queries/` are therefore written directly in SQLite syntax rather than relying on runtime dialect translation.
