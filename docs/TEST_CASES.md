...
- [backend/app/db/queries/operational_queries.sql](backend/app/db/queries/operational_queries.sql)
- [backend/app/db/queries/analytical_queries.sql](backend/app/db/queries/analytical_queries.sql)
...
- runtime database contains the documented indexes from `backend/app/db/schema/indexing.sql`
