...
The timeout settings give GLM enough time for prompt-to-SQL generation and retry one transient slow response before reporting a gateway timeout.
...
- `llm_prompt_cases.json`: 35 prompts covering operational, analytical, filtered, aggregate, ambiguous, and unsafe requests, including common English paraphrases and edge-case safety prompts
